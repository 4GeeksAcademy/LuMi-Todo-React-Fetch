...
function AddTaskForm({toggleChange, toggleAdd, toggleDeleteAll, content, toggleKey}){

    

    return <>
        <div className="d-flex justify-content-center align-items-center mt-3 gap-1 w-100"> 
            <input className="rounded border border-black py-1 px-2" style={{flexGrow:"0.8"}} name="label" value={content} onChange={toggleChange} onKeyDown={toggleKey}></input>
